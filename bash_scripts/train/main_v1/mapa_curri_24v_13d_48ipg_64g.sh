...
torchrun --nproc_per_node ${NUM_GPUS} --nnodes ${NUM_NODES} --node_rank ${NODE_RANK} \
    ...
    model.pretrained='${root_experiments_dir}/morphcloud/training/mapa_curri_4v_13d_48ipg_64g/checkpoint-last.pth' \
    ...
    hydra.run.dir='${root_experiments_dir}/morphcloud/training/mapa_curri_24v_13d_48ipg_64g'
